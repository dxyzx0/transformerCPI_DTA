...
def construct_single_data(data):
...
if __name__ == "__main__":
    ...
    with open('data/input/converted_all_data.csv',"r") as f:          # ../data/kinase_tran.txt
    #with open('data/input/kinase_dropna_clean_400.csv',"r") as f:          # ../data/kinase_tran.txt
...
#    with parallel_backend('threading', n_jobs=joblib.cpu_count()):
#        dataset = Parallel()(delayed(construct_single_data)(data) for no, data in enumerate(tqdm(data_list)))
    ...
    with open("data/output/kinase_test.txt", "wb") as f:
